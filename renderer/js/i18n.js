...
const I18N_DICT = {
  fr: {
    ...
    'wiz.t1': 'Bienvenue dans VoiceTweaker',
    'wiz.p1': 'Trois étapes rapides : ton micro, un micro virtuel optionnel, et une voix de départ.',
    'wiz.t2': 'Micro virtuel (optionnel)',
    'wiz.p2': "Pour utiliser ta voix transformée dans Discord, OBS ou tes jeux, il faut un câble audio virtuel.",
    'wiz.t3': 'Choisis une voix de départ',
    'wiz.p3': 'Tout se règle finement ensuite dans les onglets Voix et Effets.',
    'wiz.found': 'VB-CABLE détecté — tu es prêt !',
    'wiz.notfound': "VB-CABLE non détecté. Installe-le (gratuit) pour router ta voix vers Discord/OBS, ou passe cette étape.",
    'wiz.unknown': "Impossible de lire les périphériques (autorise le micro pour plus de détails).",
    'wiz.checking': 'Vérification…',
    'wiz.cableOpen': 'Ouvrir la page VB-CABLE',
    'wiz.retry': 'Revérifier',
    'wiz.skip': 'Passer',
    'wiz.back': 'Retour',
    'wiz.next': 'Suivant',
    'wiz.finish': 'Terminer',
    ...
    'label.quality': 'Mode Qualité max (vocoder, +~55 ms de latence)',
    'tip.quality': "Algorithme haute fidélité pour les voix soutenues : zéro écho de grain, latence accrue.",
  ...
  en: {
    ...
    'wiz.t1': 'Welcome to VoiceTweaker',
    'wiz.p1': "Three quick steps: your mic, an optional virtual mic, and a starting voice.",
    'wiz.t2': 'Virtual mic (optional)',
    'wiz.p2': 'To use your transformed voice in Discord, OBS or games, you need a virtual audio cable.',
    'wiz.t3': 'Pick a starting voice',
    'wiz.p3': 'Everything can be fine-tuned later in the Voice and Effects tabs.',
    'wiz.found': 'VB-CABLE detected — you are ready!',
    'wiz.notfound': 'VB-CABLE not detected. Install it (free) to route your voice to Discord/OBS, or skip this step.',
    'wiz.unknown': 'Could not read devices (allow microphone access for details).',
    'wiz.checking': 'Checking…',
    'wiz.cableOpen': 'Open the VB-CABLE page',
    'wiz.retry': 'Check again',
    'wiz.skip': 'Skip',
    'wiz.back': 'Back',
    'wiz.next': 'Next',
    'wiz.finish': 'Finish',
    ...
    'label.quality': 'Quality max mode (vocoder, +~55 ms latency)',
    'tip.quality': 'High-fidelity algorithm for sustained voices: zero grain echo, higher latency.',
